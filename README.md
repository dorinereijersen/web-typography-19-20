...
### Voorbereiding
---
Allereerst hadden we per groepjes van ongeveer vier personen een gesprekje met Darice. In dit gesprek hebben mijn groepje en ik vragen gesteld over wie Darice is en hoe het precies zit met het lezen van closed captions als iemand een hoorprobleem heeft. Hier kwamen de volgende punten uit: <br>
• Als er een achtergrond geluid is, ziet ze dit graag tussen [brackets]. <br>
• Elk persoon die wat zegt, heeft zijn eigen kleur. <br>
• Ze associeert donkere kleuren met spannendheid. <br>
• Als Darice een film kijkt, gebeurt dat meestal 's avonds. <br>
• Ze houdt van een minimalistische stijl. <br>
...
#### 'Fuck-off'
In de eerste week heb ik het een en ander geprobeerd om te kijken hoe het in eerste instantie allemaal werkt. Allereerst heb ik de body een donkere kleur gegeven, omdat Darice liever 's avonds een film kijkt. Een donker scherm is hierbij fijner voor haar ogen.<br>
Ook heb ik gekeken hoe ik 'fuck off skin job' zo kwaad of dreigend mogelijk kon maken. <br>
<img src="images/fuckoff.png" width="400"></img> 
<br>
...
<img src="images/captions.png" width="400"></img>
<br>

Ook heb ik bij de geluiden, zoals een sirene de achtergrondkleur veranderd, waardoor het lijkt op een politiesirene. <br>
<img src="images/sirene.png" width="400"></img><img src="images/sirene2.png" width="400"></img>
<br>

#### 'Out of the box'
Ik heb in scène 2 een rondje toegevoegd die het spannende geluid ondersteund wat bij de scène hoort. Deze verandert steeds van grootte. Als het geluid indringender wordt, wordt het rondje groter. Ook de kleuren veranderen hierbij, op het spannendste moment wordt het rondje rood. <br>
...
<br>
Bekijk mijn closed-captions via deze link: https://dorinereijersen.github.io/web-typography-19-20/closed-captions/index.html
